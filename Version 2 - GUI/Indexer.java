...
public class Indexer extends JFrame {
	...
	public void updateComponents() {
		...
		yPos += this.searchButton.getHeight() + yBuffer;
		//output box
		this.scroller.setBounds(xPos, yPos, (int) (this.windowWidth - this.windowWidth * xBorderBuffer - xBuffer * 2), (int) (this.windowHeight * 0.86d - 40));
